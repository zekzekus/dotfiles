hi clear
syntax reset
let g:colors_name = "zek1"
if &background == "light"
    hi Boolean gui=NONE guifg=#707070 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#ede7d4
    ...
    hi CursorColumn gui=NONE guifg=NONE guibg=#ede7d4
    hi CursorLine gui=NONE guifg=NONE guibg=#ede7d4
    ...
    hi Normal gui=NONE guifg=#000000 guibg=#fdf6e2
    ...
    hi StatusLine gui=NONE guifg=#262626 guibg=#ede7d4
...
elseif &background == "dark"
    ...
    hi ColorColumn gui=NONE guifg=NONE guibg=#073541
    ...
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    hi CursorColumn gui=NONE guifg=NONE guibg=#073541
    hi CursorLine gui=NONE guifg=NONE guibg=#073541
    ...
    hi Normal gui=NONE guifg=#b0b0b0 guibg=#002d38
    ...
    hi StatusLine gui=NONE guifg=#9e9e9e guibg=#073541
