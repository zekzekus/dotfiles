...
_G.packer_plugins = {
  ...
  ["fzf.vim"] = {
    commands = { "Files", "BTags" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/fzf.vim",
  ...
  neogit = {
    commands = { "Neogit" },
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\vneogit\19default_config\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/neogit",
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file BTags lua require("packer.load")({'fzf.vim'}, { cmd = "BTags", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
