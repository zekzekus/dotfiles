...
_G.packer_plugins = {
  ...
  ["nvim-metals"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/nvim-metals",
...
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'vim-fireplace', 'vim-jack-in', 'parinfer-rust'}, { ft = "clojure" }, _G.packer_plugins)]]
