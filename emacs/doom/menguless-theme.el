...
;;; Code:
(defmacro menguless-themes-make (name bg bg+ current-line fade fg fg+ docs red orange yellow green)
...
ORANGE, YELLOW and GREEN are pretty self-explanatory."
  `(progn
     ...
     (custom-theme-set-faces
      ...
      '(lazy-highlight ((t (:weight bold :background ,green :foreground ,docs))))
      ...
      '(org-document-title ((t (:weight bold :foreground ,fg+ :height 1.1))))
      '(org-footnote ((t ())))
      ...
      '(org-document-info-keyword ((t (:foreground ,fg+ :weight bold))))
      '(org-document-info ((t ())))
      ...
      '(markdown-header-delimiter-face ((t (:foreground ,fade :weight bold))))
      '(markdown-header-face-1 ((t (:weight bold))))
      '(markdown-header-face-2 ((t (:weight bold))))
      '(markdown-header-face-3 ((t (:weight bold))))
      '(markdown-header-face-4 ((t (:weight bold))))
      '(markdown-header-face-5 ((t (:weight bold))))
      '(markdown-header-face-6 ((t (:weight bold))))
...
(menguless-themes-make menguless
                       "#053330"    ; bg
                       "#022120"    ; bg+
                       "#053837"    ; current-line
                       "#477882"    ; fade
