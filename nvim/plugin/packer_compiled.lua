...
_G.packer_plugins = {
  ...
  ["gitsigns.nvim"] = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\rgitsigns\19default_config\0" },
    loaded = true,
  ...
  ["glow.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/glow.nvim",
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
    url = "https://github.com/tami5/lspsaga.nvim"
  },
  ["luatab.nvim"] = {
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\vluatab\19default_config\0" },
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/luatab.nvim",
  ...
  ["neo-tree.nvim"] = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\rneo-tree\19default_config\0" },
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/neo-tree.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["nvim-metals"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/nvim-metals",
  ...
  ["nvim-parinfer"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/nvim-parinfer",
    url = "https://github.com/gpanders/nvim-parinfer"
  },
  ["nvim-treesitter"] = {
    config = { "\27LJ\2\n6\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20nvim-treesitter\19default_config\0" },
    loaded = true,
  ...
  tagbar = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/tagbar",
    url = "https://github.com/preservim/tagbar"
  },
  ["telescope-ctags-outline.nvim"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/telescope-ctags-outline.nvim",
    url = "https://github.com/fcying/telescope-ctags-outline.nvim"
  },
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["telescope.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/telescope.nvim",
  ...
  ["vim-bundler"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/vim-bundler",
  ...
  ["vim-fireplace"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/vim-fireplace",
  ...
  ["vim-projectionist"] = {
    loaded = true,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/start/vim-projectionist",
  ...
  ["vim-rails"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/vim-rails",
  ...
  ["vim-rake"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/zekus/.local/share/nvim/site/pack/packer/opt/vim-rake",
  ...
  ["vim-smartclose"] = {
    ...
    url = "https://github.com/szw/vim-smartclose"
  },
  ["vim-surround"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\rgitsigns\19default_config\0", "config", "gitsigns.nvim")
time([[Config for gitsigns.nvim]], false)
-- Config for: nvim-treesitter
time([[Config for nvim-treesitter]], true)
try_loadstring("\27LJ\2\n6\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20nvim-treesitter\19default_config\0", "config", "nvim-treesitter")
time([[Config for nvim-treesitter]], false)
-- Config for: neo-tree.nvim
time([[Config for neo-tree.nvim]], true)
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\rneo-tree\19default_config\0", "config", "neo-tree.nvim")
time([[Config for neo-tree.nvim]], false)
-- Config for: luatab.nvim
time([[Config for luatab.nvim]], true)
try_loadstring("\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\vluatab\19default_config\0", "config", "luatab.nvim")
...
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'vim-fireplace', 'vim-jack-in', 'nvim-parinfer'}, { ft = "clojure" }, _G.packer_plugins)]]
vim.cmd [[au FileType json ++once lua require("packer.load")({'vim-jdaddy'}, { ft = "json" }, _G.packer_plugins)]]
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-rails', 'vim-rake', 'vim-bundler'}, { ft = "ruby" }, _G.packer_plugins)]]
