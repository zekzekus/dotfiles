;;; off-light-theme-theme.el --- Emacs theme with a light background.

;; Copyright (C) 2014 , Zekeriya Koç
...
(provide-theme 'off-light-theme)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; off-light-theme-theme.el ends here
