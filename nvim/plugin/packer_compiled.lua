...
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'nvim-parinfer', 'vim-jack-in', 'vim-fireplace'}, { ft = "clojure" }, _G.packer_plugins)]]
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-rake', 'vim-bundler', 'vim-rails'}, { ft = "ruby" }, _G.packer_plugins)]]
